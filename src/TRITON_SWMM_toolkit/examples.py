...
class GetTS_TestCases:
    ...
    UVA_norfolk_data_dir = Path("/scratch/dcl3nd/triton_swmm_toolkit_data")
    ...
    def retreive_norfolk_UVA_multisim_1cpu_case(
        ...
        return cls._retrieve_norfolk_case(
            ...
            additional_analysis_configs=dict(
                ...
                python_path="/home/dcl3nd/.conda/envs/triton_swmm_toolkit/bin/python",
