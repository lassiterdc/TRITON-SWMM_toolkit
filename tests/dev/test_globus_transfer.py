...
WORKTREE_SRC = "/home/dcl3nd/dev/hhemt/.claude/worktrees/globus-auto-transfer-and-debug-restructuring/src"
...
def test_frontier():
    ...
    spec = config.to_transfer_spec(
        analysis_dir=Path(
            "/lustre/orion/cli190/proj-shared/dcl3nd/hhemt/"
...
def test_uva():
    ...
    spec = config.to_transfer_spec(
        analysis_dir=Path(
            "/dtn/landings/users/d/dc/dcl3nd/project/quinnlab/dcl3nd/norfolk/"
