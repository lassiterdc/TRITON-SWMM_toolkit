...
def test_snakemake_sensitivity_workflow_generation_and_write(
    norfolk_frontier_sensitivity_analysis,
):
    """
    Test Snakemake workflow generation for sensitivity analysis on Frontier HPC.
    ...
    """
    analysis = norfolk_frontier_sensitivity_analysis
...
def test_snakemake_sensitivity_workflow_config_generation(
    norfolk_frontier_sensitivity_analysis, config, expected_flags
):
    """
    Test configuration passed to Snakemake for sensitivity analysis on Frontier HPC.
...
def test_snakemake_sensitivity_workflow_dry_run(
    ...
    """
    Test Snakemake dry-run for sensitivity analysis (--dry-run flag) on Frontier HPC.
...
def test_snakemake_sensitivity_workflow_execution(
    ...
    """
    Test Snakemake sensitivity analysis workflow execution on Frontier HPC with SLURM.
