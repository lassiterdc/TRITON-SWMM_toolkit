...
last_sync_hashes:
  ...
  '# Follow-up Ideas': 64fe794d9ebff03288fa4debe01ce16e8299c36ae3103c636cbfb8b8d291b956
harness: claude-code
next_phase: '1'
next_phase_title: Phase 1 — report_config schema and analysis.run() hook
next_phase_doc: /home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/visualization_and_reporting/1 reportconfig schema and analysisrun hook.md
...
- Next phase: Phase 1 — Phase 1 — report_config schema and analysis.run() hook
- Next phase doc: `/home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/visualization_and_reporting/1 reportconfig schema and analysisrun hook.md`
...
1. Sidecar scratch doc:
   `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_04-23_1737_visualization-and-reporting-multiphase-pwi/sidecars/sidecar_phase1_2026-04-24_0821.md`

2. Next phase doc:
   `/home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/visualization_and_reporting/1 reportconfig schema and analysisrun hook.md`
...
- **Phase**: 1 — Phase 1 — report_config schema and analysis.run() hook
- **Heaviness**: medium
...
`Checkpoint-match assertion: Sidecar: sidecar_phase1_2026-04-24_0821.md. Leave-off step (from
checkpoint): preflight complete, entering Phase 1. Next phase: Phase 1 — Phase 1 — report_config schema and analysis.run() hook.
