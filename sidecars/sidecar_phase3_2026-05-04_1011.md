...
main_scratch: /home/dcl3nd/dev/agentic-workspace/library/_scratch/workspaces/TRITON-SWMM_toolkit_05-03_1359_render-bundle-pwi.md
last_sync_hashes:
...
next_phase_doc: /home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/render_bundle/3 manifestharvest infrastructure renderer audit stipulation.md
leave_off_step: Phase 2 complete and pushed; entering Phase 3 (manifest-harvest infrastructure + renderer audit + stipulation)
worktree_path: /home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-03_1359_render-bundle-pwi
...
- Next phase doc: `/home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/render_bundle/3 manifestharvest infrastructure renderer audit stipulation.md`
- Worktree: `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-03_1359_render-bundle-pwi`
...
1. Sidecar scratch doc:
   `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-03_1359_render-bundle-pwi/sidecars/sidecar_phase3_2026-05-04_1011.md`

2. Next phase doc:
   `/home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/render_bundle/3 manifestharvest infrastructure renderer audit stipulation.md`
...
the Write tool directly — the sidecar lives under `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-03_1359_render-bundle-pwi/sidecars/`
...
Do NOT read the main scratch doc. Do NOT compute hashes yourself. Invoke the script via `conda run` with the `-m` form:
    ...
    conda run -n agentic python -m scripts.generate.write_compaction_sidecar --mode verify \
      --main-scratch /home/dcl3nd/dev/agentic-workspace/library/_scratch/workspaces/TRITON-SWMM_toolkit_05-03_1359_render-bundle-pwi.md \
      --worktree /home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-03_1359_render-bundle-pwi
