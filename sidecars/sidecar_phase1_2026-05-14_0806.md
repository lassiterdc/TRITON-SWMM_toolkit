...
last_sync_hashes:
  ...
  '# Follow-up Ideas': fa0677785fbcc607b25413fbbaeb709568d5ea3acb223fba9f70495a2809f906
harness: claude-code
next_phase: '1'
next_phase_title: Phase 1 — schema-canonicalization
next_phase_doc: /home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/bundle_cfg_report_canonicalization/1 schemacanonicalization.md
...
rebaselined_at: '2026-05-14T08:54:01.723364'
---
- [x] in progress
...
- Next phase: Phase 1 — Phase 1 — schema-canonicalization
- Next phase doc: `/home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/bundle_cfg_report_canonicalization/1 schemacanonicalization.md`
...
1. Sidecar scratch doc:
   `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-13_2337_bundle-cfg-report-canonicalization-pwi/sidecars/sidecar_phase1_2026-05-14_0806.md`

2. Next phase doc:
   `/home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/bundle_cfg_report_canonicalization/1 schemacanonicalization.md`
...
- **Phase**: 1 — Phase 1 — schema-canonicalization
- **Heaviness**: medium
...
`Checkpoint-match assertion: Sidecar: sidecar_phase1_2026-05-14_0806.md. Leave-off step (from
checkpoint): preflight complete, entering Phase 1. Next phase: Phase 1 — Phase 1 — schema-canonicalization.
...
1. **Phase 1 — Schema canonicalization** (medium): Add Pydantic-required `report: report_config` field to `analysis_config`; simplify `analysis.run()` resolution to 2-step; new `tests/test_config_analysis_report_field.py`.
