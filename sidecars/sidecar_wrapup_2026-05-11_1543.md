...
main_scratch: /home/dcl3nd/dev/agentic-workspace/library/_scratch/workspaces/TRITON-SWMM_toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test.md
last_sync_hashes:
  '# Follow-up Ideas': 78e04447c6305c23555bab01981374b369b017b5c37af29c68594c3012594ada
harness: claude-code
plan_name: snakemake rerun triggers empirical unit test
plan_completion_commit: bf5b74e54ca96497727cc2046f298bfa2e94b6bd
worktree_path: /home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test
created: '2026-05-11T15:43:04'
smoke_test: false
---
- [ ] in progress
...
- Plan name: snakemake rerun triggers empirical unit test
- Plan completion commit: `bf5b74e54ca96497727cc2046f298bfa2e94b6bd`
- Worktree: `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test`
- Worktree branch: `worktree-toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test`
...
1. Wrapup-handoff sidecar:
   `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test/sidecars/sidecar_wrapup_2026-05-11_1543.md`
...
- **Plan name**: `snakemake rerun triggers empirical unit test`
- **Plan completion commit**: `bf5b74e54ca96497727cc2046f298bfa2e94b6bd`
- **Worktree path**: `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test`
- **Worktree branch**: `worktree-toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test`
...
plan-closeout commit are in git history; `bf5b74e54ca96497727cc2046f298bfa2e94b6bd` points at
...
--inject-into-scratch /home/dcl3nd/dev/agentic-workspace/library/_scratch/workspaces/TRITON-SWMM_toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test.md` to append the wrapup template
...
- **Worktree path**: `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test`
- **Worktree branch**: `worktree-toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test`
- **Main scratch path**: `/home/dcl3nd/dev/agentic-workspace/library/_scratch/workspaces/TRITON-SWMM_toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test.md`
...
`Wrapup-entry assertion: Sidecar: {sidecar_filename}. sidecar_kind: wrapup_handoff_atomic. Plan name: snakemake rerun triggers empirical unit test. Plan completion commit: bf5b74e54ca96497727cc2046f298bfa2e94b6bd. Wrapup entry block present in body: YES|NO.`
...
Do NOT read the main scratch doc. Do NOT compute hashes yourself. Invoke:
    ...
    scripts/generate/write_compaction_sidecar.py --mode verify \
      --main-scratch /home/dcl3nd/dev/agentic-workspace/library/_scratch/workspaces/TRITON-SWMM_toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test.md \
      --worktree /home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-11_1241_snakemake-rerun-triggers-empirical-test
...
- Promote `event_id` from `_scenario.event_id` to a public `proc.event_id` attribute on `TRITONSWMM_sim_post_processing` to eliminate Demeter violations at consumer sites and deepen the processing-object interface (F-FU 6, Criterion 2 Module Depth and Responsibility).
- Re-evaluate `tests/test_workflow_incremental_add_remove.py` redundancy against the new empirical tests after 1-2 months of co-existence; defer removal until a regression has demonstrated which assertions catch which bug class (F-FU 7, Criterion 9 Scope Discipline).
